...
import styles from '../TradeComponent/styles.less'
    ...
    <>
      <div className={styles.statsContainer}>
        ...
        <div className={styles.statsRow}>
            ...
            <span style={{ marginRight: '5px' }}>{token_address.slice(0, 6)}...{token_address.slice(token_address.length - 4, token_address.length)}</span>
          ...
          <div className={styles.statsRow}>
            <div className={styles.label}>Pair Address</div>
            <div className={styles.value}>
            <span style={{ marginRight: '5px' }}>{pair_address.slice(0, 6)}...{pair_address.slice(pair_address.length - 4, pair_address.length)}</span>
