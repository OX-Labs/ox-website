      ...
      e.exports = (function (e) {
        ...
        function (e, t, r) {
          ...
          var n = r(0),
            ...
            c = 'fm_logout',
            u = 'fm_get_balances',
            l = 'fm_get_transactions',
            f = 'fm_is_logged_in',
            d = 'fm_accountSettings',
            p = 'fm_deposit',
            h = 'fm_get_user',
            m = 'fm_configure',
            y = {};
          e.exports = function e(t, r, n) {
            ...
            (this.apiKey = t),
              ...
              (this.transactions = {
                send: function (e, t) {
                  var r = new v(s, { to: e.to, value: e.amount });
              ...
              (this.getProvider = function () {
                return (
                  y['fortmatic-'.concat(g.queryParams)] ||
                    (y['fortmatic-'.concat(g.queryParams)] = new a.default(
                      g.fortmaticClient,
              ...
              (this.user = {
                ...
                logout: function () {
                  (g.getProvider().account = null),
                    (g.getProvider().network = null);
                  var e = new v(c);
              ...
              (this.configure = function () {
                var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ...
                      : {},
                  t = new v(m);
                return (t.params = [e]), i.sendFortmaticAsyncWrapper.call(g, t);
              });
          };
              ...
              return (
                (0, s.default)(e, [
                      ...
                      return new Promise(function (t, r) {
                        var n = function () {
                          if (
                            (function () {
                              ...
                              try {
                                for (
                                  ...
                                  if (o.value.src.includes(e.queryParams))
                                    return !1;
                              } catch (e) {
                                (r = !0), (n = e);
                              } finally {
                            ...
                            (r.innerHTML = u.default.css),
                              (r.type = 'text/css'),
                              document.head.appendChild(r);
                            var n = document.createElement('iframe');
                            (n.className = 'fortmatic-iframe'),
                              (n.src = ''
                            ...
                            console.error(
                              'Fortmatic: Duplicate instances found.',
                            );
                        };
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      if ('string' == typeof e)
                        return l.sendAsyncWrapper.call(this, e, t);
                      if (!t) {
                        console.warn(
                          'Non-async web3 methods will be deprecated in web3 > 1.0, and are not supported by the Fortmatic provider. An async method to be used instead.',
                        ),
                        ...
                        switch (e.method) {
                          ...
                          case 'net_version':
                            r =
                              this.network ||
                              (this.options.API_KEY.startsWith('pk_live')
                                ? 1
                                : 4);
                            break;
                                    ...
                                    r.batch && r.batch.length > 0
                                      ? (r.batch.forEach(function (e) {
                                          a.requests[e.id] = {
                                            ...
                                            cb: function (e, t) {
                                              var n =
                                                a.requests[r.id].batchResponse;
                                              if (
                                                e &&
                                                e.response &&
                                                !(0, l.findExistingResponse)(
                                                  n,
                                                  e.response.id,
                                                )
                                              )
                          ...
                          switch (t.data.msgType) {
                            ...
                            case e.postMessages.FORTMATIC_HANDLE_RESPONSE:
                              try {
                                ...
                                n &&
                                  e.requests[n].payload.batch.length ===
                                    e.requests[n].batchResponse.length &&
                                  e.requests[n].cb(
                                    null,
                                    e.requests[n].batchResponse,
                                  ),
                                  'eth_accounts' ===
                                  e.requests[r].payload.method
          ...
          !(function (t) {
            ...
            if (l) u && (e.exports = l);
              ...
              var v = Object.getPrototypeOf,
                g = v && v(v(k([])));
              g && g !== n && o.call(g, i) && (y = g);
              var b = (A.prototype = E.prototype = Object.create(y));
              (T.prototype = b.constructor = A),
                (A.constructor = T),
                (A[c] = T.displayName = 'GeneratorFunction'),
