  ...
  [2],
  {
    ...
    '7FJf': function (t, e, n) {
      ...
      (function (t) {
        ...
        function P(t) {
          return new Uint8Array(H(t).map((t) => parseInt(t, 2)));
        }
        function N(t) {
          return (
        ...
        function L(t) {
          return o.a.strict(t) && !B(t);
        }
        function q(t) {
          return !L(t) && !B(t) && 'undefined' !== typeof t.byteLength;
        }
        function U(t) {
          return B(t)
            ? l
        ...
        function H(t, e = 8) {
          const n = z(t).match(new RegExp(`.{${e}}`, 'gi'));
          return Array.from(n || []);
        }
        function z(t, e = 8, n = p) {
          return $(t, W(t.length, e), n);
        }
        function $(t, e, n = p) {
          return Z(t, e, !0, n);
        }
        ...
        function V(t) {
          return (t = Y(t)), (t = z(t, 2)), t && (t = Q(t)), t;
        }
        function K(t) {
          const e = t.startsWith('0x');
          return (
            (t = Y(t)), (t = t.startsWith(p) ? t.substring(1) : t), e ? Q(t) : t
          );
        }
    ...
    GM3Q: function (t, e, n) {
      ...
      n.o(o, 'IJsonRpcProvider') &&
        ...
        n.o(o, 'getBigIntRpcId') &&
          n.d(e, 'getBigIntRpcId', function () {
    ...
    Kqv8: function (t, e, n) {
      ...
      function A(t) {
        let e = null,
          n = null;
        const r = E();
        return r && (n = r.getItem(t)), (e = n ? C(n) : n), e;
      }
      function T(t) {
        const e = E();
        e && e.removeItem(t);
      ...
      function j(t) {
        ...
        I(P, Object.assign(Object.assign({}, t), { href: e }));
      }
      function B(t, e) {
        return t.filter((t) =>
      ...
      function L(t, e) {
        let n = t;
        return e && (n = e.map((e) => B(t, e)).filter(Boolean)), n;
      }
      const q = 'https://registry.walletconnect.com';
      function U() {
        return q + '/api/v2/wallets';
      }
      function D() {
        return q + '/api/v2/dapps';
      }
    ...
    Lk1n: function (t, e, n) {
      ...
      class c extends a['IJsonRpcProvider'] {
        ...
        async request(t, e) {
          return this.requestStrict(
            Object(a['formatJsonRpcRequest'])(
              t.method,
              t.params || [],
              Object(a['getBigIntRpcId'])().toString(),
            ),
            e,
          );
        }
      ...
      const h = (t) =>
        ...
        d = (t) => {
          ...
          return JSON.parse(n, (t, e) => {
            const n = 'string' === typeof e && e.match(/^\d+n$/);
      ...
      class y {
        ...
        async send(t, e) {
          ...
          try {
            const e = p(t),
              n = await l()(
                this.url,
                Object.assign(Object.assign({}, _), { body: e }),
              ),
              r = await n.json();
        ...
        async register(t = this.url) {
          ...
          try {
            const e = p({ id: 1, jsonrpc: '2.0', method: 'test', params: [] });
            await l()(t, Object.assign(Object.assign({}, _), { body: e })),
              this.onOpen();
          } catch (e) {
      ...
      var w = n('m4Dm'),
        b = n('FmZn');
      const M = 'Session currently connected',
        x = 'Session currently disconnected',
        E = 'Session Rejected',
        k = 'Missing JSON RPC response',
        S = 'JSON-RPC success response must include "result" field',
        R = 'JSON-RPC error response must include "error" field',
        C = 'JSON RPC request must have valid "method" value',
        O = 'JSON RPC request must have valid "id" value',
        I = 'Missing one of the required parameters: bridge / uri / session',
        A = 'JSON RPC response format is invalid',
        T = 'URI format is invalid',
        P = 'QRCode Modal not provided',
        N = 'User close QRCode Modal';
      class j {
        constructor() {
          this._eventEmitters = [];
        }
      ...
      class L {
        ...
        getSession() {
          let t = null;
          const e = Object(w['j'])(this.storageId);
          return e && Object(w['v'])(e) && (t = e), t;
        }
        setSession(t) {
          return Object(w['C'])(this.storageId, t), t;
        }
        removeSession() {
          Object(w['B'])(this.storageId);
        }
      }
      var q = L;
      const U = 'walletconnect.org',
        D = 'abcdefghijklmnopqrstuvwxyz0123456789',
        J = D.split('').map((t) => `https://${t}.bridge.walletconnect.org`);
      function F(t) {
        let e = t.indexOf('//') > -1 ? t.split('/')[2] : t.split('/')[0];
        return (e = e.split(':')[0]), (e = e.split('?')[0]), e;
      }
      function W(t) {
        return F(t).split('.').slice(-2).join('.');
      }
      function H() {
      ...
      class Q {
        constructor(t) {
          if (
            ...
            (this._clientMeta =
              Object(w['i'])() || t.connectorOpts.clientMeta || null),
            (this._cryptoLib = t.cryptoLib),
            (this._sessionStorage =
              t.sessionStorage || new q(t.connectorOpts.storageId)),
        ...
        set key(t) {
          if (!t) return;
          const e = Object(w['e'])(t);
          this._key = e;
        }
        get key() {
          if (this._key) {
            const t = Object(w['c'])(this._key, !0);
            return t;
          }
          return '';
        }
        ...
        get clientId() {
          ...
          return t || (t = this._clientId = Object(w['E'])()), this._clientId;
        }
        set peerId(t) {
          t && (this._peerId = t);
        }
        ...
        get clientMeta() {
          ...
          return t || (t = this._clientMeta = Object(w['i'])()), t;
        }
        set peerMeta(t) {
          this._peerMeta = t;
        }
        ...
        async createInstantRequest(t) {
          ...
          (this.handshakeId = e.id),
            (this.handshakeTopic = Object(w['E'])()),
        ...
        rejectSession(t) {
          if (this._connected) throw new Error(M);
          const e = t && t.message ? t.message : E,
        ...
        async sendCustomRequest(t, e) {
          ...
          switch (t.method) {
            ...
            case 'eth_chainId':
              return Object(w['f'])(this.chainId);
            case 'eth_sendTransaction':
            case 'eth_signTransaction':
              t.params && (t.params[0] = Object(w['y'])(t.params[0]));
              break;
            case 'personal_sign':
              t.params && (t.params = Object(w['x'])(t.params));
              break;
            default:
              break;
          }
        ...
        approveRequest(t) {
          if (!Object(w['r'])(t)) throw new Error(S);
          {
        ...
        rejectRequest(t) {
          if (!Object(w['q'])(t)) throw new Error(R);
          {
            const e = this._formatResponse(t);
            this._sendResponse(e);
          }
        ...
        _formatRequest(t) {
          if ('undefined' === typeof t.method) throw new Error(C);
          const e = {
            id: 'undefined' === typeof t.id ? Object(w['A'])() : t.id,
            jsonrpc: '2.0',
            method: t.method,
        ...
        _formatResponse(t) {
          if ('undefined' === typeof t.id) throw new Error(O);
          const e = { id: t.id, jsonrpc: '2.0' };
          if (Object(w['q'])(t)) {
            const n = Object(w['h'])(t.error),
        ...
        _subscribeToInternalEvents() {
          this.on('display_uri', () => {
            ...
            this.on('call_request_sent', (t, e) => {
              ...
              if (Object(w['s'])() && this._signingMethods.includes(n.method)) {
                const t = Object(w['j'])(w['w']);
      ...
      var rt = nt,
        ...
        it = n.n(ot),
        st = n('zy0H');
      class at extends st['IJsonRpcConnection'] {
        constructor(t) {
          super(),
            (this.events = new i.a()),
            (this.accounts = []),
        ...
        register(t) {
          ...
          const e = {
            bridge: this.bridge,
            qrcodeModal: this.qrcode ? it.a : void 0,
      ...
      class ct {
        ...
        async request(t) {
          ...
          if (w['D'].includes(t.method)) return this.signer.request(t);
        ...
        setHttpProvider(t) {
          const e = Object(w['m'])(t, this.rpc);
          if ('undefined' === typeof e) return;
          const n = new c(new y(e));
          return n;
        }
      }
      e['default'] = ct;
    ...
    WOvk: function (t, e, n) {
        ...
        if (
          ...
          if (((i = t.style), 'string' == typeof n)) i.cssText = n;
            ...
            if (('string' == typeof r && ((i.cssText = ''), (r = null)), r))
              for (c in r) (n && c in n) || R(i, c, '');
            if (n) for (u in n) (r && n[u] === r[u]) || R(i, u, n[u]);
          }
        else
          'o' === e[0] && 'n' === e[1]
      ...
      (r.__r = function (t) {
        ...
        (r.diffed = function (t) {
          ...
          if (e) {
            ...
            n &&
              n.__h.length &&
              ((1 !== H.push(e) && F === r.requestAnimationFrame) ||
                (
      ...
      ((kt.prototype = new y()).u = function (t) {
        ...
        return (
          ...
          function (o) {
            var i = function () {
              e.props.revealOrder ? (r.push(o), St(e, t, r)) : o();
            };
            n ? n(i) : i();
          }
        );
      ...
      r.vnode = function (t) {
        ...
        if (e) {
          if (
            (n.class != n.className &&
              ((Bt.enumerable = 'className' in n),
              null != n.className && (n.class = n.className),
              Object.defineProperty(n, 'className', Bt)),
            'function' != typeof e)
          ) {
            var r, o, i;
    ...
    dFyl: function (t, e, n) {
      (function (e) {
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                p || (!e && !s && !S.length)
                  ...
                  : a.createElement(
                      C,
                      Object.assign({}, g, { links: S, errorMessage: I }),
                    ),
              ),
            ),
          );
        ...
        var P = {
          ...
          J = { de: P, en: N, es: j, fr: B, ko: L, pt: q, zh: U, fa: D };
        function F() {
        ...
        function K(t, e, n) {
          console.log(t), V() ? c(t) : Y(t, e, n);
        }
        function Z() {
          V() || Q();
        }
        var G = { open: K, close: Z };
        t.exports = G;
      }).call(this, n('Q2Ig'));
    },
    dYBg: function (t, e, n) {
    ...
    m4Dm: function (t, e, n) {
        ...
        function e(t) {
          ...
          return (
            ('number' === typeof t || ('string' === typeof t && !k(t))) &&
              (R(t) ? 'string' === typeof t && (e = y(t)) : (e = g(t))),
      ...
      function J(t, e) {
        let n = F(t);
        return (n = Object.assign(Object.assign({}, n), e)), (t = W(n)), t;
      }
      function F(t) {
        return U['parse'](t);
      }
    ...
    mrSG: function (t, e, n) {
      ...
      function y(t, e, n) {
        ...
        function c(t) {
          t.value instanceof v
            ? Promise.resolve(t.value.v).then(u, l)
            : h(i[0][2], t);
        }
        function u(t) {
          a('next', t);
    ...
    qmMu: function (t, e, n) {
      ...
      function k(t, e, n) {
        ...
        var k,
          ...
          C = 0;
        for (k = 0; k < b; k++)
          for (S = 0; S < c; S++) k < y[S].length && (R[C++] = y[S][k]);
        for (k = 0; k < g; k++) for (S = 0; S < c; S++) R[C++] = w[S][k];
        return R;
      }
      function S(t, e, n, r) {
        var i;
    ...
    veq9: function (t, e, n) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 });
      const r = n('mrSG');
      r.__exportStar(n('/GNo'), e), r.__exportStar(n('4f1M'), e);
    },
    vvrf: function (t, e, n) {
      var r = n('u/Db'),
        o = n('3X7Y'),
